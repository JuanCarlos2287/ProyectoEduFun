...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener {
  ...
  //  MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        au_a = MediaPlayer.create(MainActivity3.this, R.raw.a);
        au_b = MediaPlayer.create(MainActivity3.this, R.raw.b);
        au_c = MediaPlayer.create(MainActivity3.this, R.raw.c);
        au_d = MediaPlayer.create(MainActivity3.this, R.raw.d);
        au_e = MediaPlayer.create(MainActivity3.this, R.raw.e);
        au_f = MediaPlayer.create(MainActivity3.this, R.raw.f);
        au_g = MediaPlayer.create(MainActivity3.this, R.raw.g);
        au_h = MediaPlayer.create(MainActivity3.this, R.raw.h);
        au_i = MediaPlayer.create(MainActivity3.this, R.raw.i);
        au_j = MediaPlayer.create(MainActivity3.this, R.raw.j);
        au_k = MediaPlayer.create(MainActivity3.this, R.raw.k);
        au_l = MediaPlayer.create(MainActivity3.this, R.raw.l);
        au_m = MediaPlayer.create(MainActivity3.this, R.raw.m);
        au_n = MediaPlayer.create(MainActivity3.this, R.raw.n);
        au_nn = MediaPlayer.create(MainActivity3.this, R.raw.nn);
        au_o = MediaPlayer.create(MainActivity3.this, R.raw.o);
        au_p = MediaPlayer.create(MainActivity3.this, R.raw.p);
        au_q = MediaPlayer.create(MainActivity3.this, R.raw.q);
        au_r = MediaPlayer.create(MainActivity3.this, R.raw.r);
        au_s = MediaPlayer.create(MainActivity3.this, R.raw.s);
        au_t = MediaPlayer.create(MainActivity3.this, R.raw.t);
        au_u = MediaPlayer.create(MainActivity3.this, R.raw.u);
        au_v = MediaPlayer.create(MainActivity3.this, R.raw.v);
        au_w = MediaPlayer.create(MainActivity3.this, R.raw.w);
        au_x = MediaPlayer.create(MainActivity3.this, R.raw.x);
        au_y = MediaPlayer.create(MainActivity3.this, R.raw.y);
        au_z = MediaPlayer.create(MainActivity3.this, R.raw.z);
